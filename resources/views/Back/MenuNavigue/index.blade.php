...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Liste des navbar</a></li>
        </ol>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if($navs->etat==0)
                                       ...
                                       <td style="display: none;">{{$navs->id}}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($navs->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
                            ...
                            @include('Back.MenuNavigue.add')
@if( $nav_count!=0)
@include('Back.MenuNavigue.edit')
@include('Back.MenuNavigue.view')
@include('Back.MenuNavigue.delete')
@include('Back.MenuNavigue.state')
@endif
