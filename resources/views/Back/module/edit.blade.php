                  ...
                  <div class="card-header" style="text-align:center;justify-content:center;">
                      ...
                      <div class="card-body">
                          <div class="basic-form">
                              <form action="{{route('Module.update',0)}}" method="POST">
                                <input type="hidden" class="form-control"  name="id" id="update_id" id="exampleInputEmail1" placeholder="Nom">

                                @csrf
                                @method('PUT')
                                  <div class="mb-3">
                                      <input type="text" id="nom_module"  name="nom_module" class="form-control input-default " placeholder="Nom module">
                                  </div>
                                  <div class="mb-3">
                                      <input type="text" id="caption"   name="caption" class="form-control input-rounded" placeholder="Diminutif">
                                  </div>
                                  <div class="mb-3">
                                    <input type="hidden" name="detail2"  >
                                  <textarea class="form-control" name="detail"  placeholder="Description"></textarea>
                                  </div>
                                  <input type="hidden" name="navigation2" >
