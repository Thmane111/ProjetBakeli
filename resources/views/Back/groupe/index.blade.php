                        ...
                        <table class="table table-responsive-md">
                            <thead>
                                <tr>
                                    ...
                                    <th><strong>Nom groupe</strong></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$groupe_comp++;}}</td>
                                    <td>{{$groupes->nom_groupe}}</td>
                                    <td>{{$groupes->caption}}</td>
                                    <td style="display: none;">{{$groupes->detail}}</td>
                                    <td>@if($groupes->etat==0)
                                       ...
                                       <td style="display: none;">{{$groupes->id}}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($groupes->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
                            ...
                            @include('Back.groupe.add')
@if( $groupe_count!=0)
@include('Back.groupe.edit')
@include('Back.groupe.view')
@include('Back.groupe.delete')
@include('Back.groupe.state')
@endif
