...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Liste des plan d'abonnements</a></li>
        </ol>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if($plans->etat==0)
                                       ...
                                       <td style="display: none;">{{$plans->id}}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($plans->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
                            ...
                            @include('Back.plan_abonnement.add')
@if( $plan_count!=0)
@include('Back.plan_abonnement.edit')
@include('Back.plan_abonnement.view')
@include('Back.plan_abonnement.delete')
@include('Back.plan_abonnement.state')
@endif
