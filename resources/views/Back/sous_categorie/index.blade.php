                        ...
                        <table class="table table-responsive-md">
                            <thead>
                                <tr>
                                    ...
                                    <th><strong>sous categorie</strong></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$sous_cat_comp++;}}</td>
                                    <td>{{$sous_cats->nom_type}}</td>
                                    <td>{{$sous_cats->icon? $sous_cats->icon->nom_icon:'null'}}</td>
                                    <td>{{$sous_cats->Categorie? $sous_cats->Categorie->nom_cat:''}}</td>

                                    <td style="display: none;">{{$sous_cats->id}}</td>
                                    <td style="display: none;">{{$sous_cats->Categorie? $sous_cats->Categorie->id:''}}</td>
                                    <td>@if($sous_cats->etat==0)
                                        <span class="badge light badge-danger" style="font-size:15px; ">desactver</span>
                                        @elseif($sous_cats->etat==1)
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($sous_cats->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
                            ...
                            @include('Back.sous_categorie.add')
@if( $sous_cat_count!=0)
@include('Back.sous_categorie.edit')
@include('Back.sous_categorie.view')
@include('Back.sous_categorie.delete')
@include('Back.sous_categorie.state')
@endif
