                        ...
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$cats->nom_cat}}</td>
                                    <td>{{$cats->caption}}</td>
                                    <td style="display: none;">{{$cats->detail}}</td>
                                    <td>@if($cats->etat==0)
                                       ...
                                       <td style="display: none;">{{$cats->id}}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item state" href="#">@if($cats->etat==0)
                                                    activer
                                                    @else desactiver
                                                    @endif
                                                   </a>
                            ...
                            @include('Back.categorie.add')
@if( $cat_count!=0)
@include('Back.categorie.edit')
@include('Back.categorie.view')
@include('Back.categorie.delete')
@include('Back.categorie.state')
@endif
