...
<html class="fixed">
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="{{asset('Back/assets/stylesheets/skins/default.css')}}" />
		...
		<section class="body-sign">
			<div class="center-sign">
				<a href="/" class="logo pull-left">
					<img src="{{asset('Back/assets/images/logo.png')}}" height="54" alt="Porto Admin" />
				</a>
    ...
    @endif
            ...
            @csrf
							...
							<p class="text-center">Don't have an account yet? <a href="{{route('admin.register')}}">Sign Up!</a>
