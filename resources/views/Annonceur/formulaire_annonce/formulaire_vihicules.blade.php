...
@section('content')
        ...
        @include('Annonceur.formulaire_annonce.prenium');
       <!-- MultiStep Form -->
                    ...
                    <div class="col-md-12 mx-0">
                        <form id="msform" action="{{route('app.storeA')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                ...
                                <a href="javascript:void(0)" onclick="$('#pro-image').click()" class="btn btn-warning">Upload image</a>
                                @if(Auth::user()->type_annonceur_id==2)
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            >
                                             Oui
                                             <input type="radio" value="1" name="liv">
